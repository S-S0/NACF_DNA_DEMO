...
public class OpenAiService {
    ...
    public String ask(String userPrompt) {
        ...
        String instructions = """
                ...
                - 답변은 1000자 이내로 간결하게 해주세요.
                - 사용자가 특정 기관(예: 신한은행, KB국민은행 등)을 비교 대상으로 요청했으나 제공된 [fin_ratio_serving]에 그 기관 데이터가 없을 경우:
                  → 반드시 web_search_preview 도구를 사용해 해당 기관의 최신 재무비율(ROE, ROA, NIM, CET1, LCR 등)을 검색해 요약하고 비교 결과를 작성하세요.
                - 도구 호출 여부와 무관하게, 항상 마지막에는 한국어 '최종 답변 텍스트'를 출력하세요.
                """;
